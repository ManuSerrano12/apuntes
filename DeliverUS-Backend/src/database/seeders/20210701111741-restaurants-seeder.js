    ...
    */
    ...
    await queryInterface.bulkInsert('Restaurants',
      [
        ...
        { name: '30 products', description: '1000 products', address: 'Józefa 34, Kraków, Poland', postalCode: '123-4567', url: 'http://1000products.com/', restaurantCategoryId: 2, shippingCosts: 1.5, email: 'info@restaurant.com', phone: '+48123456789', createdAt: new Date(), updatedAt: new Date(), userId: 2, status: 'offline' },
